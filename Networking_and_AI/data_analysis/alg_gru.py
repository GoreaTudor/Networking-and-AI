...
def run_gru(train_df: DataFrame,
            test_df: DataFrame,
    ...
    # predict
    y_pred_probs = model.predict(test_seq_x)
    y_pred = y_pred_probs.argmax(axis=1)

    # decode labels to strings
    test_labels_str = le_attack.inverse_transform(test_seq_y)
    pred_labels_str = le_attack.inverse_transform(y_pred)
...
if __name__ == '__main__':
    ...
    run_gru(training_df, testing_df)
